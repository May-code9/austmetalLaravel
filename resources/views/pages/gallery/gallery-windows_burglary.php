<?php
$title = 'Ausmetal | Gallery: Windows and Burglary Proofs';
$gallery = "moto-widget-menu-link-active";
$meta = "<meta name='description' content='Here are some of our Windows and Burglary Proofs'/>";
          ...
          <div class="moto-cell col-sm-12" data-container="container">
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default">
              <div class="moto-widget-text-content moto-widget-text-editable">
                <p style="text-align: center;" class="moto-text_system_4">Gallery: Windows and Burglary Proofs<br></p>
              </div>
            </div>
            <div data-widget-id="wid__grid_gallery__58abf0900095d" class="moto-widget moto-widget-grid-gallery moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="grid_gallery" data-preset="default" data-spacing="aaaa">
              <div class="moto-widget-grid-gallery-items"  data-moto-grid-gallery-options='{&quot;rowHeight&quot;:358,&quot;fixedHeight&quot;:false,&quot;margins&quot;:30,&quot;lastRow&quot;:&quot;justify&quot;,&quot;showCaptions&quot;:true,&quot;enableLightbox&quot;:true}'>
                <a  href="../mt-demo/59400/59427/mt-content/uploads/2016/12/mt-0789-gallery-img1-big.jpg" class="moto-widget-grid-gallery-item">
                  <img src="../mt-demo/59400/59427/mt-content/uploads/2016/12/mt-0789-gallery-img1.jpg" alt="Windows and Burglary Proofs 1" class="moto-widget-grid-gallery-image">
                  <div class="caption caption_html moto-widget-text ">
                    <p class="moto-text_system_6"><span class="moto-color5_4">Project #1</span></p>
                  </div>
                </a>
                <a  href="../mt-demo/59400/59427/mt-content/uploads/2016/12/mt-0789-gallery-img2-big.jpg" class="moto-widget-grid-gallery-item">
                  <img src="../mt-demo/59400/59427/mt-content/uploads/2016/12/mt-0789-gallery-img2.jpg" alt="Windows and Burglary Proofs 2" class="moto-widget-grid-gallery-image">
                  <div class="caption caption_html moto-widget-text ">
                    <p class="moto-text_system_6"><span class="moto-color5_4">Project #2</span></p>
                  </div>
                </a>
                <a  href="../mt-demo/59400/59427/mt-content/uploads/2016/12/mt-0789-gallery-img3-big.jpg" class="moto-widget-grid-gallery-item">
                  <img src="../mt-demo/59400/59427/mt-content/uploads/2016/12/mt-0789-gallery-img3-big.jpg" alt="Windows and Burglary Proofs 3" class="moto-widget-grid-gallery-image">
                  <div class="caption caption_html moto-widget-text ">
                    <p class="moto-text_system_6"><span class="moto-color5_4">Project #3</span></p>
                  </div>
                </a>
                <a  href="../mt-demo/59400/59427/mt-content/uploads/2016/12/mt-0789-gallery-img4-big.jpg" class="moto-widget-grid-gallery-item">
                  <img src="../mt-demo/59400/59427/mt-content/uploads/2016/12/mt-0789-gallery-img4.jpg" alt="Windows and Burglary Proofs 4" class="moto-widget-grid-gallery-image">
                  <div class="caption caption_html moto-widget-text ">
                    <p class="moto-text_system_6"><span class="moto-color5_4">Project #4</span></p>
                  </div>
                </a>
                <a  href="../mt-demo/59400/59427/mt-content/uploads/2016/12/mt-0789-gallery-img5-big.jpg" class="moto-widget-grid-gallery-item">
                  <img src="../mt-demo/59400/59427/mt-content/uploads/2016/12/mt-0789-gallery-img5.jpg" alt="Windows and Burglary Proofs 5" class="moto-widget-grid-gallery-image">
                  <div class="caption caption_html moto-widget-text ">
                    <p class="moto-text_system_6"><span class="moto-color5_4">Project #5</span></p>
                  </div>
                </a>
                <a  href="../mt-demo/59400/59427/mt-content/uploads/2016/12/mt-0789-gallery-img6-big.jpg" class="moto-widget-grid-gallery-item">
                  <img src="../mt-demo/59400/59427/mt-content/uploads/2016/12/mt-0789-gallery-img6.jpg" alt="Windows and Burglary Proofs 6" class="moto-widget-grid-gallery-image">
                  <div class="caption caption_html moto-widget-text ">
                    <p class="moto-text_system_6"><span class="moto-color5_4">Project #6</span></p>
                  </div>
                </a>
              </div>
            </div>
...
<?php
require_once("../includes/footer3.inc.php");
?>

<div data-moto-back-to-top-button class="moto-back-to-top-button"></div>
<script src="../mt-includes/js/website.assets.min68be.js?_build=1487660422" type="text/javascript" data-cfasync="false"></script>
