...
class IrondoorController extends Controller
{
    /**
    ...
    {
      $irondoor = 'active';
      return view('admin.layouts.crud.irondoor', compact('irondoor'));
    }
    ...
    public function store(Request $request)
    {
      ...
      $destinationPath = public_path('/img/IronDoors');
      ...
      $irondoor->project_number = $projectNumber;
      $irondoor->image = $photo;
      $irondoor->image_title = $imagename;
      $irondoor->image_title2 = $imagename2;
      $irondoor->save();
