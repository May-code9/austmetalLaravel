...
class HandrailController extends Controller
{
    ...
    {
      $handrail = 'active';
      return view('admin.layouts.crud.handrail', compact('handrail'));
    }
    ...
    public function store(Request $request)
    {
      ...
      $destinationPath = public_path('/img/Handrails');
      ...
      $handrail->project_number = $projectNumber;
      $handrail->image = $photo;
      $handrail->image_title = $imagename;
      $handrail->image_title2 = $imagename2;
      $handrail->save();
